...
> **อัปเดต 2026-07-02:** ปัจจุบัน `alice-pi` ถอดจอ 2.8" ออกแล้ว เปลี่ยนเป็น
> **Waveshare Zero LCD HAT (A) 3 จอ** — ดูโฟลเดอร์
> [ST7789V_Zero_LCD_HAT_A/](ST7789V_Zero_LCD_HAT_A/) (deploy + ทดสอบผ่านแล้ว)
> ชุดไฟล์ 2.8" ในโฟลเดอร์นี้ยังใช้ติดตั้งกลับได้ทุกเมื่อด้วย `install.sh`
