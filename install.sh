...
echo "== [1/6] ติดตั้ง panel firmware (ILI9341 init sequence) =="
install -m 644 "$SCRIPT_DIR/firmware/panel.bin" /lib/firmware/panel.bin

echo "== [2/6] ตรวจ device-tree overlays =="
